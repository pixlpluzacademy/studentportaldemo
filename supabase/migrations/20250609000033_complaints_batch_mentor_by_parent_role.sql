-- Resolve student batch mentors by parent role (mentor), not batch staff_type label.
-- Includes HOD (superior mentor), mentor, and trainer slots on the student's batch.
