-- Allow enrolled students with my-courses.view to read linked course + department rows.
-- Uses security definer helpers to avoid departments <-> courses RLS recursion.
