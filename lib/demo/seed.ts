...
export const demoModules: DemoModule[] = [
  ...
  { id: 'hod_review', label: 'HOD Review', href: '/task-submissions', description: 'Superior mentor review of submissions and mentor scoring.', actions: ['view', 'review', 'approve', 'edit'] },
  { id: 'final_qa', label: 'Final QA', href: '/task-submissions', description: 'Final validation, QA comments and score locking.', actions: ['view', 'validate', 'lock', 'approve', 'export'] },
  ...
  // Admissions UI hidden for now — keep module id for permissions/DB compatibility.
  { id: 'admissions', label: 'Admissions', href: '/dashboard', description: 'Website admission leads from home, contact and enquiry forms.', actions: ['view', 'edit', 'export'] },
